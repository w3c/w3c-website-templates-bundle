...
class TwigExtension extends AbstractExtension
{
    ...
    public function formatTable($content)
    {
        $html5 = new HTML5();
        ...
        foreach ($figures as $figure) {
            ...
            // If a caption has been entered, move this out of <figcaption> (which can be removed) and into <caption>, which should be the first child element of <table>
