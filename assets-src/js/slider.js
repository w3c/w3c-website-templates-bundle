		...
		if (slider) {
			...
			if (slides.length > 1) {
				...
				function createControls() {
					...
					controls.innerHTML = '<li><button class="button button--ghost js-previous with-icon--larger" aria-label="' + previousSlide + '" style="padding:0.4375rem;"><svg xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 320 512" class="icon icon--larger" focusable="false" aria-hidden="true" width="1em" height="1em"><use crossorigin="anonymous" class="chevron-left" href="' + jsAssetsPath + 'svg/nav-icons.svg#chevron-left"></use><use crossorigin="anonymous" class="chevron-right" href="' + jsAssetsPath + 'svg/nav-icons.svg#chevron-right"></use></svg></button></li>'
