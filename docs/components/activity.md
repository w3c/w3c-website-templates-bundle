        ...
        <div class="component component--columns component--columns--images">
            ...
            <ul class="clean-list" role="presentation">
                <li>
                    <div class="card card--news" data-component="card">
                        <div class="card__text">
                            <h3 class="card__heading"><a href="../page.html" class="card__link">W3C starts web payments standards work</a></h3>
                ...
                <li>
                    <div class="card card--news" data-component="card">
                        <div class="card__text">
                            <h3 class="card__heading"><a href="../page.html" class="card__link">Work begins on extensions to WCAG 2.0</a></h3>
                ...
                <li>
                    <div class="card card--event workshop" data-component="card">
                        <div class="card__text">
                            <h3 class="card__heading"><a href="../page.html" class="card__link">How do you want to pay?</a></h3>
                ...
                <li>
                    <div class="card card--event talk" data-component="card">
                        <div class="card__text">
                            <h3 class="card__heading"><a href="../page.html" class="card__link">Cognitive AI - mimicking how we think</a></h3>
